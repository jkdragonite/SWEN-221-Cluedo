...
/**
 * A subclass of Card which is used to represent cards with weapon information
...
public class WeaponCard extends Card{
	...
	/**
	 * Creates a new instance of a WeaponCard with the given information
	 * @param info
	 */
	public WeaponCard(String info) {
		super(info);
	}
